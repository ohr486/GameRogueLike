...
use super::{WantsToPickupItem, Name, InBackpack, Position, gamelog::GameLog,
            WantsToDrinkPotion, Potion, CombatStats, WantsToDropItem};
...
impl<'a> System<'a> for PotionUseSystem {
    ...
    fn run(&mut self, data: Self::SystemData) {
        ...
        for(entity, drink, stats) in (&entries, &wants_drink, &mut combat_stats).join() {
            ...
            match potion {
                ...
                Some(potion) => {
                    ...
                    entries.delete(drink.potion).expect("Delete failed");
                }
            }
        }
